...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-twa#6ez#or+%7!n+u)_)qkf@)qs4jj5f(o9twkr6wz^3=mh_7r')
...
CSRF_TRUSTED_ORIGINS = [
    "https://aflah263.pythonanywhere.com",
]
...
# Session Security
SESSION_COOKIE_AGE = 2592000  # 30 days (default for "Remember me")
SESSION_EXPIRE_AT_BROWSER_CLOSE = False # Let the view handle it
